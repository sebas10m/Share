resource "azurerm_resource_group" "orphan" {
  name     = "orphan-resources"
  location = "West Europe"
}

resource "azurerm_application_insights_workbook" "orphan" {
  name                = "85b3e8bb-fc93-40be-83f2-98f6bec18ba0"
  resource_group_name = azurerm_resource_group.orphan.name
  location            = azurerm_resource_group.orphan.location
